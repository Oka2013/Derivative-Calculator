...
byte derivatives[19][3][30] = {
    {
        {OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, OP_DONE},
        {OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DONE},
        },
    {
        ...
        },
    {
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0xbf, OP_DONE},
        },
    {
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DEL, OP_DONE},
        {OP_SWAP, OP_DEL, OP_DONE},
        },
    {
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_SWAP, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_SWAP, OP_DIV, OP_DONE},
        {OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40, OP_POW, OP_DIV, OP_NEG, OP_DONE},
        },
    {
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DUP, OP_PICK, 2, OP_MUL, OP_SWAP, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_SUB, OP_POW, OP_SWAP, OP_DEL, OP_DONE},
        {OP_SWAP, OP_DUP, OP_LN, OP_SWAP, OP_PICK, 2, OP_POW, OP_MUL, OP_SWAP, OP_DEL, OP_DONE},
        },
    {
    ...
    {
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_LN, OP_MUL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_SWAP, OP_DIV, OP_DONE},
        {OP_DUP, OP_LN, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40, OP_POW, OP_MUL, OP_SWAP, OP_LN, OP_SWAP, OP_DIV, OP_DONE},
        },
    {
        {OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_SWAP, OP_DIV, OP_DONE},
        {OP_DONE},
        },
    {
        {OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
    ...
    {
        {OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DUP, OP_ABS, OP_DIV, OP_DONE},
        {OP_DONE},
        },
    {
        {OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40, OP_MUL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_SWAP, OP_DIV, OP_DONE},
        {OP_DONE},
        },
    {
        {OP_DEL, OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_DUP, OP_DUP, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_SWAP, OP_SUB, OP_SWAP, OP_DIV, OP_PICK, 2, OP_SWAP, OP_POW, OP_SWAP, OP_DIV, OP_SWAP, OP_DEL, OP_DONE},
        {OP_DUP, OP_LN, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_PICK, 2, OP_DIV, OP_POW, OP_SWAP, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40, OP_POW, OP_DIV, OP_DONE},
        },
    {
        {OP_DEL, OP_PUSH, CH_CONSTANT, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0, 0x3f, OP_DONE},
        {OP_COS, OP_DONE},
